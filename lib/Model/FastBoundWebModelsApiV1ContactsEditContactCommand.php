...
/**
 * FastBoundWebModelsApiV1ContactsEditContactCommand Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FastBoundWebModelsApiV1ContactsEditContactCommand implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FastBound.Web.Models.Api.V1.Contacts.EditContact+Command';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['status_note'] = isset($data['status_note']) ? $data['status_note'] : null;
     ...
     * Sets status
     *
     * @param string $status NOTE: this is a string because the default model binder returns the field name and a blank error message  if the caller sends an invalid enum value. At least this way, they'll get a better error message.
     *
     * @return $this
     */
    ...
    {
        return $this->container['status_note'];
    }

    /**
     * Sets status_note
     *
     * @param string $status_note status_note
     *
     * @return $this
     */
    public function setStatusNote($status_note)
    {
        $this->container['status_note'] = $status_note;
